...
class PeopleConverter(BaseConverter):
    ...
    def _add_to_idf(self, val_data: PeopleSchema):
        ...
        self.idf.add(People(
            ...
            surface_name_angle_factor_list_name=val_data.surface_name_angle_factor_list_name or None,
            work_efficiency_schedule_name=val_data.work_efficiency_schedule_name or None,
            clothing_insulation_calculation_method=val_data.clothing_insulation_calculation_method,
            clothing_insulation_calculation_method_schedule_name=val_data.clothing_insulation_calculation_method_schedule_name or None,
            clothing_insulation_schedule_name=val_data.clothing_insulation_schedule_name or None,
            air_velocity_schedule_name=val_data.air_velocity_schedule_name or None,
            thermal_comfort_model_1_type=val_data.thermal_comfort_model_1_type or None,
            thermal_comfort_model_2_type=val_data.thermal_comfort_model_2_type or None,
            thermal_comfort_model_3_type=val_data.thermal_comfort_model_3_type or None,
            thermal_comfort_model_4_type=val_data.thermal_comfort_model_4_type or None,
            thermal_comfort_model_5_type=val_data.thermal_comfort_model_5_type or None,
            thermal_comfort_model_6_type=val_data.thermal_comfort_model_6_type or None,
            thermal_comfort_model_7_type=val_data.thermal_comfort_model_7_type or None,
            ankle_level_air_velocity_schedule_name=val_data.ankle_level_air_velocity_schedule_name or None,
